# Roblox Heal Engine 0.10.0-rc.3 — Stable Qualification Candidate
...
The 0.10.0-rc.3 candidate validates the adoption workflow on
...
The 0.10.0-rc.3 release workflow produces unsigned Windows x64 and Ubuntu x64
...
`ci/verify-stability-streak.py` proof plus a version-only commit after the
